...
For verifying customer and payment information in the browser, use [Web App][stripe-js].
...
```ts
const paymentIntent: Stripe.PaymentIntent = await stripe.paymentIntents.retrieve('pi_123456789', {
  expand: ['customer'],
});
